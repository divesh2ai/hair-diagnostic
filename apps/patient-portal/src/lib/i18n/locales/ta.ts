...
export const ta: Dictionary = {
  ...
  nav: {
    ...
    leads: "லீட்கள்",
    people: "நபர்கள் & அணுகல்",
    clinicalGovernance: "மருத்துவ நிர்வாகம்",
    actionCentre: "செயல் மையம்",
    fulfilment: "நிறைவேற்றம்",
    operations: "செயல்பாடுகள்",
    auditSecurity: "தணிக்கை & பாதுகாப்பு",
    sectionNetwork: "வலையமைப்பு",
