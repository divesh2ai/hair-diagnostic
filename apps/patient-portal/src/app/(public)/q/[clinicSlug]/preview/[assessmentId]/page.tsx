    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-50 via-white to-stone-50 text-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-6 pb-32 sm:px-6 lg:px-8">
        ...
        {videoState === "READY" && data?.video.url ? (
          ...
          /* UNAVAILABLE — graceful fallback to report-first layout */
          <div className="mb-4 rounded-2xl border border-amber-200 bg-amber-50/70 px-4 py-3 text-sm text-amber-900">
            We couldn&apos;t generate your personalized briefing video right now — your full
            report is below.
          </div>
        )}
