        ...
        <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-stone-200 bg-white/95 backdrop-blur-md shadow-[0_-4px_24px_-12px_rgba(15,23,42,0.12)]">
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              {/* Doctor-reviewed one-page summary — a separate document from the
                  long-form PDF above, and ready as soon as the clinical report is.
                  It must not live inside the pdfUrl branch: the long-form PDF is
                  only generated on demand, so gating on it hid the patient
                  one-pager for the whole window right after the assessment. */}
              {reportIsReady && (
                <a
